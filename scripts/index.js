...
function renderElement(initialMassiveObject) {
  const templateElements = document
    .querySelector("#element-template")
    .content.firstElementChild.cloneNode(true);
  templateElements.querySelector(".element__image").src =
    initialMassiveObject.link;
  templateElements.querySelector(".element__image").alt =
    initialMassiveObject.name;
  templateElements.querySelector(".element__caption").textContent =
    initialMassiveObject.name;
  elements.prepend(templateElements);
}
