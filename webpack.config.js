...
package.json в разделе devDependencies появится новая строка:
 ...
 if (Couldn't find remote ref refs/heads/gh-pages) {
  ...
  авторизоваться с логином и паролем, По умолчанию логин — имя когорты, а email —<имя_когорты>@ya.ru.
  cohort-41 - 96eScBoG1MCkXSTAIKIfYXL2ymBZP2Ce
  npm login
